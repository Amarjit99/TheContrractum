        ...
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link to="/contact/quote" className="px-8 py-4 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-orange-500/25 flex items-center gap-2">
                                Optimize Production
                                <ArrowRight size={20} />
                            </Link>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="order-2 lg:order-1 relative">
                            <div className="absolute inset-0 bg-linear-to-tr from-orange-600/20 to-amber-600/20 rounded-3xl transform -rotate-3"></div>
                            <img
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="mt-10">
                                <Link to="/contact/touch" className="text-orange-600 font-bold hover:text-orange-700 inline-flex items-center gap-2 group">
            ...
            <div className="py-24 bg-white">
                <div className="max-w-5xl mx-auto px-6 lg:px-8">
                    <div className="bg-linear-to-r from-orange-600 to-amber-600 rounded-3xl p-12 text-center text-white relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link to="/contact/quote" className="px-8 py-4 bg-white text-orange-600 font-bold rounded-lg hover:bg-gray-50 transition-colors shadow-lg">
                                    Get Started
                                </Link>
