                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link to="/contact/quote" className="px-8 py-4 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-green-500/25 flex items-center gap-2">
                                Request Demo
                                <ArrowRight size={20} />
                            </Link>
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <div className="mt-10">
                                <Link to="/solutions/sustainability" className="text-green-600 font-bold hover:text-green-700 inline-flex items-center gap-2 group">
                                    Explore AgriTech
                    ...
                    <div className="bg-linear-to-r from-green-600 to-lime-600 rounded-3xl p-12 text-center text-white relative overflow-hidden shadow-2xl">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link to="/contact/quote" className="px-8 py-4 bg-white text-green-600 font-bold rounded-lg hover:bg-gray-50 transition-colors shadow-lg">
                                    Contact Us
                                </Link>
