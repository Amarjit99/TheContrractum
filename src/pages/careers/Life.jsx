...
export default function Life() {
    ...
    const perks = [
        ...
        { icon: <Music className="w-8 h-8 text-purple-600" />, title: "Music & Gaming", desc: "Relax in our gaming zones or jam in the music room." },
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-teal-500 via-blue-500 to-purple-600 text-white py-24">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2">
                            <div className="p-12 md:p-16 flex flex-col justify-center">
                                ...
                                <Link to="/resources/csr">
                                    <button className="bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-400 hover:to-orange-400 text-gray-900 font-bold py-3 px-8 rounded-full transition-all transform hover:scale-105 shadow-lg w-fit">
            ...
            <div className="bg-white py-20 text-center">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <Link to="/careers/jobs">
                        <button className="bg-gray-900 text-white hover:bg-black font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-lg">
                            See Open Roles
                        </button>
                    </Link>
                </div>
