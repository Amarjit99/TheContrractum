...
export default function Projects() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-violet-600 via-purple-600 to-indigo-600 text-white py-24">
                    ...
                    {projects.map((project, index) => (
                        <div key={index} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 flex flex-col group">
                            ...
                            <div className="border-t border-gray-100 pt-6">
                                ...
                                <button className="w-full py-3 rounded-xl border-2 border-gray-200 text-gray-700 font-bold hover:border-violet-500 hover:text-violet-600 transition-all flex items-center justify-center gap-2">
                    ...
                    <div className="bg-black rounded-3xl overflow-hidden shadow-2xl relative">
                        ...
                        <div className="relative z-10 px-6 py-20 text-center">
                            ...
                            <div className="flex justify-center gap-4">
                                <button className="bg-violet-600 hover:bg-violet-700 text-white font-bold py-3 px-8 rounded-full transition-all">
                                    Register Team
                                </button>
                                <button className="bg-transparent border border-gray-600 text-white hover:bg-white/10 font-bold py-3 px-8 rounded-full transition-all">
                                    View Themes
                                </button>
                            </div>
                        </div>
