...
export default function Growth() {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 text-white py-24">
            ...
            <div className="bg-white py-20 text-center">
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <Link to="/careers/jobs">
                        <button className="bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-lg">
                            Find Your Role
                        </button>
                    </Link>
                </div>
