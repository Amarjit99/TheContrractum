                                ...
                                >
                                    <div className="relative h-64 overflow-hidden">
                                        ...
                                        <div className="absolute top-4 left-4 flex gap-2">
                                            <span className={`px-3 py-1 rounded-full text-xs font-bold ${project.status === 'Published' ? 'bg-green-100 text-green-700 border border-green-300' :
                                ...
                                >
                                    <div className="md:flex">
                                        <div className="md:w-1/3 relative h-64 md:h-auto overflow-hidden">
                                            ...
                                            <span className={`absolute top-4 left-4 px-3 py-1 rounded-full text-xs font-bold ${project.status === 'Published' ? 'bg-green-100 text-green-700 border border-green-300' :
                                                    project.status === 'Ongoing' ? 'bg-blue-100 text-blue-700 border border-blue-300' :
                                                        'bg-yellow-100 text-yellow-700 border border-yellow-300'
                                                }`}>
                                                {project.status}
