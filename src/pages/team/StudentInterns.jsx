                        ...
                        >
                            ...
                            <div className="flex-1 mt-4 md:mt-0">
                                <div className="hidden md:block">
                                    ...
                                    <p className="text-red-500 font-semibold mb-3">{intern.role}</p>
                                </div>
            ...
            <div className="bg-gradient-to-r from-orange-500 via-red-500 to-pink-500 text-white py-20">
                <div className="max-w-4xl mx-auto px-6 text-center">
                    ...
                    <Link to="/careers/internships">
                        <button className="bg-white text-red-600 hover:bg-gray-100 font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-lg cursor-pointer">
                            Apply Now
                        </button>
                    </Link>
                </div>
